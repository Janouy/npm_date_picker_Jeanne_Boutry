...
describe("Calendar", () => {
	...
	describe("The isCalendarOpen props is true", () => {
		it("Should open the calendar", async () => {
			render(<Calendar weekDays={weekDays} traducedMonths={months} isCalendarOpen={true} language={"en"} />);
	...
	describe("The isCalendarOpen props is false", () => {
		it("Should close the calendar", async () => {
			render(<Calendar weekDays={weekDays} traducedMonths={months} isCalendarOpen={false} language={"en"} />);
			const calendar = screen.getByTestId("calendar");
